...
const WeatherDayItem = ({day, minTemp, maxTemp, condition, active=false, index, icon}) => {
    ...
    return <div data-id={index} className={`flex flex-col items-center space-y-1 transition duration-300 ${active && "bg-yellow-50 ring-1"} hover:bg-yellow-50 px-4 cursor-pointer rounded`}>
